...
class CalculateSize implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct(ItemUrl $item_url)
    {
        $this->item_url = $item_url;
        $item = ProjectItem::find($item_url->item_id);
        $project = Project::find($item->project_id);
        $this->company = Company::find($project->company_id);
    }
