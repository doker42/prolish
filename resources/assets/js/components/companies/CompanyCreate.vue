        ...
        <div class="card my-3">
            <div class="card-body">
                <div class="container">
                    ...
                    <form v-if="!isSumbit" class=".hide-form" v-on:submit="saveForm()">
                        <div class="row">
                            <label class="control-label breadcrumb h4 bg-light w-100">{{ trans('custom.general_information')
                            }}</label>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                <label class="control-label">{{ trans('custom.company_name') }}*</label>
                                <input v-validate="'required'" name="title" type="text" v-model="company.title"
                                    class="form-control" required>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label class="control-label">{{ trans('custom.industry') }}*</label>
                                <v-select v-model="company.industry_id" :options="industries" label="title" index="id"
                                    :clearable="false"
                                    :placeholder="isListLoading ? 'Loading...' : isListError ? 'Cannot get any industry...' : 'Type for search...'"></v-select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 form-group specialization_wrapp">
                                <label class="control-label">{{ trans('custom.specialization') }}*</label>
                                <v-select v-model="company_specialization" :options="specializations" label="title"
                                    index="id" @input="addSpecializationItem" :clearable="false"
                                    :placeholder="isListLoading ? 'Loading...' : isListError ? 'Cannot get any specialization...' : 'Type for search...'"></v-select>
                                <div class="selected_values"></div>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label class="control-label">{{ trans('custom.number_of_employees') }}*</label>
                                <v-select v-model="company.employees_number" :options="employee_numbers" label="title"
                                    index="id" :clearable="false"
                                    :placeholder="isListLoading ? 'Loading...' : isListError ? 'Cannot get any employee...' : 'Type for search...'"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <label class="control-label breadcrumb h4 bg-light w-100">{{
                                trans('custom.company_legal_information') }} <span class="h6 ml-2 mt-2">*({{trans('custom.required_for_verification') }})</span></label>
                        </div>

                        <div class="row">
                            <div class="col-sm-12 col-md-6 form-group">
                                <label class="control-label">{{ trans('custom.company_address') }}*</label>
                                <input name="company_address" type="text" v-model="company.company_address"
                                    class="form-control">
                            </div>
                            <div class="col-sm-12 col-md-6 form-group">
                                <label class="control-label">{{ trans('custom.company_number') }}*</label>
                                <input name="registration_number" type="number" v-model="company.company_number"
                                    class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <label class="control-label breadcrumb h4 bg-light w-100">{{
                                trans('custom.company_form_contacts') }}</label>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 col-md-6 form-group">
                                <label class="control-label">{{ trans('custom.office_address') }}*</label>
                                <input name="office_address" type="text" v-model="company.office_address"
                                    class="form-control">
                            </div>
                            <div class="col-sm-12 col-md-6 form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 form-group">
                                ...
                                <input v-on:change="isValidUrl('linkedin')" name="linkedin" type="text"
                                    v-model="company.linkedin" class="form-control">
                            </div>
                            <div class="col-sm-12 col-md-6 form-group">
                                <label class="control-label">{{ trans('custom.facebook') }}</label>
                                <input v-on:change="isValidUrl('facebook')" name="facebook" type="text"
                                    v-model="company.facebook" class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 col-md-6 form-group">
                                <label class="control-label">{{ trans('custom.twitter') }}</label>
                                <input v-on:change="isValidUrl('twitter')" name="twitter" type="text"
                                    v-model="company.twitter" class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 col-md-6 form-group">
