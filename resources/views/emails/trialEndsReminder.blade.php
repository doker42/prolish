...
@section('email_content')
    ...
    <img style="margin:auto;display:block;margin-top: 9%;"
         src="{{ asset('images/email/trial_period_ending_email.png')}}">
    ...
    margin-bottom: 6.6%;
    padding-left: 12.3%;
    padding-right: 12.3%;">{{trans('custom.this_is_the_reminder_that_your_free_trial_period', [], $opts['lang'])}}</div>

    <div style="font-size: 16px;
    margin-top: 6.6%;
    margin-bottom: 6.6%;
    padding-left: 12.3%;
    padding-right: 12.3%;">{{trans('custom.in_case_you_wont_choose_any_your_acces', ['date' => $opts['date']], $opts['lang'])}}</div>
